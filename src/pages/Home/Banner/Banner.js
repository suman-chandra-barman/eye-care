    ...
    >
      ...
      <div className="hero-content md:text-center text-neutral-content py-16">
        <div className="w-full">
          <h1 className="mb-3 md:mb-5 text-3xl md:text-6xl font-bold">
            Eye Care Services For You
          </h1>
          <p className="mb-5  text-lg md:text-3xl">
            Give Your Vision The Treatment It Deserves.
          </p>
          <button className="btn btn-outline text-white  border-2 border-white rounded-3xl px-10 py-1 hover:border-success hover:bg-success">
